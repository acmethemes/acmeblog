				...
				setTimeout(function () {
					$.ajax({
						...
						success: function (response) {
							...
							redirect_uri =
								acmeblog_adi_install.adminurl +
								'/themes.php?page=advanced-import&browse=all&at-gsm-hide-notice=welcome';
							if ($('.at-gsm-close').length) {
								dismiss_nonce = $('.at-gsm-close')
									.attr('href')
									.split('at_gsm_admin_notice_nonce=')[1];
