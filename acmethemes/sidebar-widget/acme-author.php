...
if ( ! class_exists( 'acmeblog_author_widget' ) ) :
    ...
    class acmeblog_author_widget extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'acmeblog_author_title' ) ); ?>"><?php _e( 'Title:', 'acmeblog' ); ?></label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'acmeblog_author_title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'acmeblog_author_title' ) ); ?>" type="text" value="<?php echo esc_attr( $acmeblog_author_title ); ?>" />
            </p>
            <h4><?php _e( 'Author Image', 'acmeblog' ); ?></h4>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id('acmeblog_author_image') ); ?>">
                ...
                <input type="text" class="widefat" name="<?php echo esc_attr( $this->get_field_name('acmeblog_author_image') ); ?>" id="<?php echo esc_attr( $this->get_field_id('acmeblog_author_image') ); ?>" value="<?php echo esc_url( $acmeblog_author_image ); ?>" />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'acmeblog_author_short_disc' ) ); ?>"><?php _e( 'Author Short Disc:', 'acmeblog' ); ?></label>
                <textarea class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'acmeblog_author_short_disc' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'acmeblog_author_short_disc' ) ); ?>"><?php echo esc_html( $acmeblog_author_short_disc ); ?></textarea>
            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'acmeblog_author_link' ) ); ?>"><?php _e( 'Link URL:', 'acmeblog' ); ?></label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'acmeblog_author_link' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'acmeblog_author_link' ) ); ?>" type="text" value="<?php echo esc_attr( $acmeblog_author_link ); ?>" />
            </p>
            <p>
                <input id="<?php echo esc_attr( $this->get_field_id( 'acmeblog_author_new_window' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'acmeblog_author_new_window' ) ); ?>" type="checkbox" <?php checked( 1 == $acmeblog_author_new_window ? $instance['acmeblog_author_new_window'] : 0); ?> />
                <label for="<?php echo esc_attr( $this->get_field_id( 'acmeblog_author_new_window' ) ); ?>"><?php _e( 'Open in new window', 'acmeblog' ); ?></label>
            </p>
            <hr />
            <?php
        }
